...
function CookieModal() {
  ...
  const clickCerrarCookies = () => {
    ...
    if (widthViewport >= 900) {
      //si es una pc 
      cookieModal.style.animation = `${header.closeCookiesPC} 200ms ease forwards`
    } else {
      //si no es mayor que 900 entra aqui

      cookieModal.style.animation = `${header.closeCookiesMobile} 200ms ease forwards`
    }
